...
class ExceptionsTest extends TestCase
{
    ...
    {
        $this->expectException(\Rivalex\Breadcrumbs\Exceptions\DuplicateBreadcrumbException::class);
    ...
    {
        $this->expectException(\Rivalex\Breadcrumbs\Exceptions\InvalidBreadcrumbException::class);
    ...
    {
        $this->expectException(\Rivalex\Breadcrumbs\Exceptions\ViewNotSetException::class);
